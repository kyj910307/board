                    ...
                    $.ajax({
                        ...
                        success     :    function(retVal){
                            ...
                            if(retVal.code != "OK") {
                                ...
                                location.href = "/user/board/edit?id="+$("#board_id").val();
                            }
